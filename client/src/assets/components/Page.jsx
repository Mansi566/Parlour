...
// import tshirt from "../images/Group 2085662934.png";
// import watches from "../images/Group 2085662935.png";
// import earrings from "../images/Group 2085662936.png";
// import kurti from "../images/Group 2085662942.png";
// import jewellery from "../images/Group 2085662947.png";
// import nailpaint from "../images/Group 2085662937.png";
// import chniyacholi from "../images/Group 2085662938.png";
// import saree from "../images/Group 2085662939.png";
// import purse from "../images/Group 2085662940.png";
// import mehndi from "../images/Group 2085662941.png";
// import pants from "../images/Group 2085662943.png";
...
function Page() {
  ...
  const images = [
  "/images/profile.png",
  "/images/message-chat-view.png",
  "/images/product-details.png",
  "/images/home.png",   
  "/images/splash.png",
];

  // ✅ SLIDER FIX (optimized)
  useEffect(() => {
    const interval = setInterval(() => {
  ...
  return (
    <>
      ...
      <nav className="flex justify-between items-center p-4">
        <div>
          <img
            src="/images/logo.png" 
            alt="logo"
            className="w-70 px-10"
          />
        </div>

        <div className="flex items-center mr-15">
          <ul className="flex space-x-7 mr-3 my-3 font-semibold cursor-pointer">
            <li onClick={() => scrollToSection(70)} className="hover:text-[#F9A392]">Home</li>
            <li onClick={() => scrollToSection(800)} className="hover:text-[#F9A392]">Category</li>
            <li onClick={() => scrollToSection(1400)} className="hover:text-[#F9A392]">About</li>
            <li onClick={() => scrollToSection(3400)} className="hover:text-[#F9A392]">Contact</li>
          </ul>

          <Link to="/login" className="bg-[#a94ef0] text-white px-4 py-2 mr-3 rounded-lg">
            Login
          </Link>

          <Link to="/download" className="bg-[#a94ef0] text-white px-4 py-2 rounded-lg">
            Download App
          </Link>
        </div>
      </nav>
      ...
      <header className="relative text-center">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <img
            ...
            alt="logo"
          />
          <h1 className="text-white text-5xl font-bold mt-3">THE PARLOUR</h1>
        </div>
      </header>
      ...
      <div className="text-center my-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-7 gap-6 max-w-5xl mx-auto mt-10">
          {[
            "group-2085662945.png",
            "group-2085662932.png",
            "group-2085662933.png",
            "group-2085662934.png",
            "group-2085662935.png",
            "group-2085662936.png",
            "group-2085662942.png",
            "group-2085662947.png",
            "group-2085662937.png",
            "group-2085662938.png",
            "group-2085662939.png",
            "group-2085662940.png",
            "group-2085662941.png",
            "group-2085662943.png",
          ].map((img, i) => (
            <img
              key={i}
               src={`/images/${img}`}
              className="w-20 h-20 mx-auto hover:scale-110 transition"
              alt="cat"
            />
          ))}
        </div>
      ...
      <div className="py-20 text-center bg-gray-50">
        <h2 className="text-4xl font-bold mb-10">The Parlour App</h2>

        <div className="flex justify-center items-center gap-4">
          {/* Left */}
          <img
            src={images[(currentIndex + 3) % images.length]}
            className="w-40 blur-sm hidden md:block"
            alt=""
          />
          ...
          <div className="relative">
            ...
            <img
              src={images[currentIndex]}
              className="absolute top-2 left-2 w-[90%] h-[95%] rounded-2xl"
              alt=""
            />
          </div>
          ...
          {images.map((_, i) => (
            <button
              ...
              className={`h-2 rounded-full ${
                currentIndex === i ? "w-6 bg-purple-600" : "w-2 bg-gray-300"
              }`}
            />
          ))}
        </div>
      ...
      {showButton && (
        <button
          ...
          className="fixed bottom-6 right-6 bg-purple-600 text-white p-3 rounded-full"
        >
