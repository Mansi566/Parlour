...
//     /* <slide image> */
//   }
//   const images = ["/public/profile.png", "/public/message-chat-view.png", "/public/product-details.png", "/public/home.png", "/public/splash.png"];
...
//   const images1 = ["/public/message-chat-view.png", "/public/product-details.png", "/public/home.png", "/public/splash.png", "/public/profile.png"];
...
//   const images2 = ["/public/product-details.png", "/public/home.png", "/public/splash.png", "/public/profile.png", "/public/message-chat-view.png"];
...
//   const images3 = ["/public/home.png", "/public/splash.png", "/public/profile.png", "/public/message-chat-view.png", "/public/product-details.png"];
...
//   const images4 = ["/public/splash.png", "/public/profile.png", "/public/message-chat-view.png", "/public/product-details.png", "/public/home.png"];
...
//         <div>
//           <img src="/public/logo.png" alt="logo" className="w-70 px-10"  />
//         </div>
...
//             <Link to="/hair">
//               <img
//                 src="/public/group-2085662945.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/shoes">
//               <img
//                 src="/public/group-2085662932.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/gown">
//               <img
//                 src="/public/group-2085662933.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/tshirt">
//               <img
//                 src="/public/group-2085662934.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/watches">
//               <img
//                 src="/public/group-2085662935.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/earrings">
//               <img
//                 src="/public/group-2085662936.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/kurti">
//               <img
//                 src="/public/group-2085662942.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/jewellery">
//               <img
//                 src="/public/group-2085662947.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/nailpaint">
//               <img
//                 src="/public/group-2085662937.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/chniyacholi">
//               <img
//                 src="/public/group-2085662938.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/saree">
//               <img
//                 src="/public/group-2085662939.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/purse">
//               <img
//                 src="/public/group-2085662940.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/mehndi">
//               <img
//                 src="/public/group-2085662941.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//             <Link to="/pants">
//               <img
//                 src="/public/group-2085662943.png"
//                 alt="missing"
//                 width="100"
//                 height="100"
//                 style={{ cursor: "pointer" }}
...
//           <img src="/public/group.png" alt="missing" className="w-60 h-45" />
//           <img src="/public/ios.png" alt="missing" className="w-60 h-45" />
//         </div>
//       </div>
//       {/* <Part-4> */}
...
const NAV_LINKS = [
  { label: "Home", offset: 70 },
  { label: "Category", offset: 800 },
  { label: "About Us", offset: 1400 },
  { label: "Contact Us", offset: 3400 },
];

const CATEGORIES = [
  { id: 1, path: "/hair", img: "/group-2085662945.png" },
  { id: 2, path: "/shoes", img: "/group-2085662932.png" },
  { id: 3, path: "/gown", img: "/group-2085662933.png" },
  { id: 4, path: "/tshirt", img: "/group-2085662934.png" },
  { id: 5, path: "/watches", img: "/group-2085662935.png" },
  { id: 6, path: "/earrings", img: "/group-2085662936.png" },
  { id: 7, path: "/kurti", img: "/group-2085662942.png" },
  { id: 8, path: "/jewellery", img: "/group-2085662947.png" },
  { id: 9, path: "/nailpaint", img: "/group-2085662937.png" },
  { id: 10, path: "/chniyacholi", img: "/group-2085662938.png" },
  { id: 11, path: "/saree", img: "/group-2085662939.png" },
  { id: 12, path: "/purse", img: "/group-2085662940.png" },
  { id: 13, path: "/mehndi", img: "/group-2085662941.png" },
  { id: 14, path: "/pants", img: "/group-2085662943.png" },
];

const APP_IMAGES = [
  "/profile.png",
  "/message-chat-view.png",
  "/product-details.png",
  "/home.png",
  "/splash.png",
];
...
function Page() {
  ...
  const handleScrollTo = (top) => {
    window.scrollTo({ top, behavior: "smooth" });
  };

  // Helper to get image based on index offset
  const getSlideImg = (offset) => APP_IMAGES[(currentIndex + offset) % APP_IMAGES.length];
  ...
  return (
    <div className="overflow-x-hidden">
        ...
        <div className="flex items-center mr-15">
          <ul className="flex space-x-7 mr-3 my-3 font-semibold">
            {NAV_LINKS.map((link) => (
              <li
                key={link.label}
                className="hover:text-[#F9A392] cursor-pointer"
                onClick={() => handleScrollTo(link.offset)}
              >
                {link.label}
              </li>
            ))}
          </ul>
          <button className="bg-[#a94ef0] text-white px-4 py-2 mr-3 rounded-lg hover:bg-[#b365f0]">
            <Link to="/login">Login</Link>
          </button>
          <button className="bg-[#a94ef0] text-white px-4 py-2 rounded-lg hover:bg-[#b365f0]">
      ...
      {/* <header> */}
      <header className="relative text-center h-[600px]">
        <img
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center w-full">
          <img src="/logo-copy.png" alt="Logo" className="w-40 h-40 object-contain" />
          <h3 className="text-white text-6xl font-bold mt-2 mb-5 font-['Baloo_Bhaijaan']">
            THE PARLOUR
          </h3>
          <p className="text-white text-lg font-medium font-['Baloo_Bhaijaan'] px-4">
            A simple marketplace to buy and sell pre-loved items. <br />
            Explore affordable finds and chat with sellers easily.
          </p>
        </div>
      </header>
      ...
      <div className="flex flex-col my-32 text-center">
        <h1 className="font-bold text-3xl">Category</h1>
        <p className="text-sm text-[#777] mt-2 mb-10">
          Find trendy pre-loved fashion at your fingertips.
        </p>
        <div className="grid grid-cols-2 md:grid-cols-7 gap-8 max-w-6xl mx-auto px-10">
          {CATEGORIES.map((cat) => (
            <Link key={cat.id} to={cat.path}>
              <img
                src={cat.img}
                alt="category"
                className="w-24 h-24 hover:scale-110 transition duration-300 mx-auto"
              />
            </Link>
          ))}
        </div>
      ...
      {/* <About> */}
      <section className="container mx-auto px-10 my-32 flex flex-col md:flex-row items-center gap-10">
        <div className="md:w-1/2 flex justify-center">
          <img src="/about.png" alt="About" className="rounded-2xl w-4/5" />
        </div>
        <div className="md:w-1/2">
          <h1 className="font-bold text-2xl mb-4 font-['Baloo_Bhaijaan']">About Us</h1>
          <div className="border-l-2 border-[#F9A392] pl-6 text-[#777] text-sm leading-relaxed font-['Baloo_Bhaijaan']">
            The Parlour is a modern marketplace created to give pre-loved fashion a fresh new life...
            <br /><br />
            Join our community where fashion moves forward responsibly and affordably.
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-20 relative overflow-hidden">
        <h1 className="text-center font-bold text-4xl mb-10 font-['Baloo_Bhaijaan']">
          The Parlour App
        </h1>
        <div className="flex justify-center items-center gap-4">
          {/* Background blurred phones */}
          <div className="hidden lg:flex gap-4">
            <img src={getSlideImg(3)} className="w-40 h-80 object-cover rounded-xl blur-[1px] opacity-70" />
            <img src={getSlideImg(4)} className="w-40 h-80 object-cover rounded-xl blur-[1px] opacity-70" />
          </div>
          
          {/* Main Display */}
          <div className="relative z-10">
             <img src="/new-mobile.png" className="absolute top-0 left-0 w-full h-full z-20 pointer-events-none" />
             <img src={getSlideImg(0)} className="w-60 h-[480px] object-cover rounded-[30px]" />
          </div>

          <div className="hidden lg:flex gap-4">
            <img src={getSlideImg(1)} className="w-40 h-80 object-cover rounded-xl blur-[1px] opacity-70" />
            <img src={getSlideImg(2)} className="w-40 h-80 object-cover rounded-xl blur-[1px] opacity-70" />
          </div>
        </div>
        ...
        <div className="flex justify-center gap-2 mt-8">
          {APP_IMAGES.map((_, i) => (
            <button
              ...
              className={`w-3 h-3 rounded-full ${currentIndex === i ? "bg-green-500" : "bg-gray-300"}`}
            />
          ))}
        </div>
      </section>

      {/* <Footer and Contact info remains similar but cleaned up with tailwind classes /> */}
      <footer className="bg-[#211E1C] text-white pt-20 pb-10 px-10">
         <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
               <img src="/logo.png" alt="Logo" className="w-60 mb-6" />
               <p className="text-[#F9A392] mb-6">A trusted marketplace for pre-loved clothing and lifestyle items.</p>
               <div className="w-10 h-10 bg-[#F9A392] flex items-center justify-center rounded hover:bg-[#fc876a] cursor-pointer">
                  <FontAwesomeIcon icon={faInstagram} size="lg" />
               </div>
            </div>
            <div className="flex flex-col gap-6">
                <h4 className="uppercase font-bold">Quick Links</h4>
                <div className="grid grid-cols-1 gap-2 text-gray-400">
                   {NAV_LINKS.map(link => (
                     <button key={link.label} onClick={() => handleScrollTo(link.offset)} className="text-left hover:text-[#F9A392]">
                        <FontAwesomeIcon icon={faAngleRight} className="mr-2" /> {link.label}
                     </button>
                   ))}
                </div>
            </div>
      ...
      {showButton && (
        <button
          ...
          className="fixed bottom-6 right-6 bg-[#046bd2] text-white w-10 h-10 rounded shadow-lg flex items-center justify-center hover:scale-110 transition"
        >
