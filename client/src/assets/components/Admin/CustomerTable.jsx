          ...
          <table className="w-full text-left border-separate border-spacing-0">
            <thead>
              <tr className="bg-white text-gray-400 text-xs uppercase tracking-widest font-semibold">
                <th className="px-6 py-4 border-b border-gray-100">Profile</th>
                <th className="px-6 py-4 border-b border-gray-100">First Name</th>
                <th className="px-6 py-4 border-b border-gray-100">Last Name</th>
              ...
              {customers.length > 0 ? (
                customers.map((user) => (
                  ...
                  >
                    ...
                    {/* First Name */}
                    <td className="px-6 py-4 font-bold text-gray-800 group-hover:text-blue-700 transition-colors">
                      {user.name}
                    </td>
